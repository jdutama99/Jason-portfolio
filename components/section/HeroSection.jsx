...
export const HeroSection = () => {
  ...
  return (
    <section ref={ref} id='home' className='scroll-mt-50'>
      <div className='lg:h-max bg-hero bg-no-repeat bg-auto lg:bg-cover bg-center bg-fixed grid grid-cols-1 md:grid-cols-12  px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 py-14 lg:py-28 gap-6 '>
